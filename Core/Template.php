...
class Template
{
    ...
    public static $cache_path = 'Storage/Framework/Cache/';
    public static $cache_enabled = Config::CACHE;
    ...
    public static function includeFiles($file)
    {
        ...
        foreach ($matches as $value) {
            $code = str_replace($value[0], self::includeFiles(dirname(__DIR__).'/App/Views/'.$value[2]), $code);
        }
